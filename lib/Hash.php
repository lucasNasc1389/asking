...
class Hash
{
     ...
     * http://php.net/manual/pt_BR/function.hash-algos.php
     *
     * @link http://php.net/manual/pt_BR/
     * function.hash-algos.php Função hash_algos, com a lista 
	...
	/**
     * Gera o hash de uma string para ser usada na senha do 
     * usuário.
     *
